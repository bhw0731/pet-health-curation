    ...
    <div className="rounded-2xl border border-stone-200 bg-stone-50/60 p-5 sm:p-8">
      ...
      <div className="overflow-hidden rounded-3xl border border-stone-100 bg-white">
        <div className="grid md:grid-cols-5">
          <div className="space-y-3 bg-stone-100 p-6 md:col-span-2">
            <div className="flex items-center gap-4">
              <div className="h-16 w-16 animate-pulse rounded-2xl bg-stone-200" />
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-5">
        <div className="flex flex-col items-center gap-4 rounded-2xl border border-stone-100 bg-white p-6 lg:col-span-2">
          <div className="h-40 w-40 animate-pulse rounded-full bg-stone-200" />
          <Bar className="h-4 w-40" />
        </div>
        <div className="space-y-3 rounded-2xl border border-stone-100 bg-white p-6 lg:col-span-3">
          <Bar className="h-4 w-32" />
          <div className="mx-auto h-48 w-48 animate-pulse rounded-full bg-stone-200" />
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        {[0, 1].map((i) => (
          <div key={i} className="space-y-3 rounded-2xl border border-stone-100 bg-white p-6">
