...
const SERVICES = [
  ...
  { view: null, emoji: '🐾', label: '유기동물 입양', desc: '준비 중', live: false, accent: 'from-slate-50 to-slate-100' },
  { view: null, emoji: '🛡️', label: '펫보험 비교', desc: '준비 중', live: false, accent: 'from-slate-50 to-slate-100' },
];
    ...
    <div className="bg-slate-50 py-10 sm:py-14">
      <div className="mx-auto max-w-4xl px-4">
        <header className="mb-6">
          <h1 className="text-2xl font-extrabold text-slate-900 sm:text-3xl">서비스</h1>
          <p className="mt-1.5 text-slate-500">반려생활에 필요한 모든 것을 한 곳에서 🐾</p>
        </header>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
          {SERVICES.map((s) => (
            <button
              ...
              className={`flex flex-col items-start gap-3 rounded-2xl border border-slate-100 bg-white p-5 text-left transition ${
